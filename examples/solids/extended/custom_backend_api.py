...
try:
    ...
    has_pillow = False
try:
    from g4f.integration.markitdown import MarkItDown, StreamInfo
    has_markitdown = True
except ImportError as e:
    has_markitdown = False
try:
    from g4f.gui.server.crypto import rsa, serialization, create_or_read_keys, decrypt_data, encrypt_data, get_session_key
    has_crypto = True
except ImportError:
    has_crypto = False
...
from g4f.providers.response import FinishReason, AudioResponse, MediaResponse, Reasoning, HiddenResponse
from g4f.client.helper import filter_markdown
from g4f.tools.files import supports_filename, get_streaming, get_bucket_dir, get_tempfile
from g4f.tools.run_tools import iter_run_tools
from g4f.errors import ProviderNotFoundError, MissingAuthError
from g4f.image import is_allowed_extension, process_image, MEDIA_TYPE_MAP
from g4f.cookies import get_cookies_dir
from g4f.image.copy_images import secure_filename, get_source_url, get_media_dir, copy_media
...
class CustomBackend_Api(CustomApi):    
    """

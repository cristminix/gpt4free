...
from g4f.errors import ProviderNotFoundError, ModelNotFoundError, ProviderNotWorkingError, StreamNotSupportedError
from g4f.models import Model, ModelUtils, default, default_vision
...
def get_model_and_provider(model    : Union[Model, str], 
    ...
    if hasattr(provider,"is_extended"):
        debug.log(f'Extended {provider.is_extended}')

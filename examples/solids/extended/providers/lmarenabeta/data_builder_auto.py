...
def build_evaluation_data_auto(
    model_id: str, 
    prompt: str, 
    userMessageId: str, 
    modelAMessageId: str, 
    ...
    # debug.log(EVALUATION_SESSION_ID)
    # conversation_json = ConversationJson(EVALUATION_SESSION_ID)
    # conversation_json.set("evaluationSessionId",evaluationSessionId)
    processed_messages=[]
    system_messages=[]
